...
public class Enemy_Final_Boss_Dark : Enemy_Base
{
    ...
    [SerializeField] private AudioClip pullChargeSound;   // 끌어당기기 탄환 차지/시전
    [SerializeField] private AudioClip pullFireSound;     // 끌어당기기 탄환 발사
    [SerializeField] private AudioClip darkFloorCastSound; // 어둠 바닥 시전
    [SerializeField] private AudioClip bossBulletSound;    // 보스 탄환 발사 (모든 패턴 공통)
    [SerializeField] private AudioClip dashChargeSound;    // 대시 준비/차지
    [SerializeField] private AudioClip dashExecuteSound;   // 대시 돌진
    [SerializeField] private AudioClip meleeAttackSound;   // 근거리 공격

...
/// 일반공격과 폭발탄환 모두 시전시간 적용 - 사운드 시스템 포함 - 죽음 상태 체크 추가
/// </summary>
...
public class Enemy_Ranged : Enemy_Base
{
    ...
    protected override void ResetForPooling()
    {
        ...
        Debug.Log($"{enemyName}: Enemy_Ranged 전용 상태 리셋 완료");
    }
    ...
    private void CancelAllAttackInvokes()
    {
        ...
        Debug.Log($"{enemyName}: 모든 공격 관련 지연 실행 메서드들 취소 완료");
    }
    ...
    private void ResetAttackStates()
    {
        ...
        Debug.Log($"{enemyName}: 모든 공격 상태 초기화 완료");
    }
